...
WORKDIR /src
COPY ["Gateways/RestGateway/RestGateway.csproj", "Gateways/RestGateway/"]
RUN dotnet restore "Gateways/RestGateway/RestGateway.csproj"
COPY . .
WORKDIR "/src/Gateways/RestGateway"
